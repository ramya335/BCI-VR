import websocket # ip install websocket-client
from datetime import datetime
import json
import ssl
import time
import sys
from pydispatch import Dispatcher # pip install python-dispatch
...
class Cortex(Dispatcher):
    ...
    def sub_request(self, stream):
        ...
        while True:
            ...
            if result_dic.get('com') != None:
                ...
                print(new_data)
                return new_data #Added by chowa3

    # Added by chowa3
    def unsub_request(self, streams):
    ...
    def get_mental_command_active_action(self, profile_name):
        ...
        result = self.ws.recv()
        result_dic = json.loads(result)
        return result_dic #added by chowa3
